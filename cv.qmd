...
# Count the number of corresponding/senior author papers
# pattern <- c("u2020", "Hilton, Laura K.\\}", "Hilton, Laura K\\}", "Hilton, Laura\\}")
# corr_author_count <- str_count(text_content, paste0(pattern, collapse = "|"))
